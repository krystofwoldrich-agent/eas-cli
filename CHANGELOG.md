...
- [eas-cli] Add `--network-capture` to `eas simulator` to record HTTP(S) traffic from apps on the device. ([#4300](https://github.com/expo/eas-cli/pull/4308) by [@gwdp](https://github.com/gwdp))
